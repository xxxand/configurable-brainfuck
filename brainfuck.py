...
def main(argv: list[str] | None = None, stdin: TextIO | None = None) -> int:
    ...
    parser.add_argument("--mode", choices=PROFILES, default="unlimited")
    parser.add_argument("--cell-mode", choices=(UNBOUNDED, "wrap"))
    parser.add_argument("--cell-bits", type=_parse_cell_bits)
    parser.add_argument("--tape-min", type=_parse_bound)
    parser.add_argument("--tape-max", type=_parse_bound)
    parser.add_argument("--eof-mode", choices=("zero", "unchanged", "error"))
    parser.add_argument("--output-mode", choices=("unicode", "byte"))
    parser.add_argument("--max-steps", type=_parse_non_negative_integer)
